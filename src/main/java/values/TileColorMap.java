...
public final class TileColorMap {
    ...
    private static final EnumMap<TileType, Color> tileColors = new EnumMap<>(
            TileType.class);
    ...
    static {
        ...
        tileColors.put(TileType.PORTAL, Color.MAGENTA);
        tileColors.put(TileType.COLLECTIBLE, Color.CYAN);
    }
