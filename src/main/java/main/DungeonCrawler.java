...
public class DungeonCrawler implements Runnable {
    ...
    private static final Logger LOGGER = Logger
            .getLogger(DungeonCrawler.class.getName());
    ...
    public DungeonCrawler(ThreadWrapper threadWrapper, GameEngine gameEngine,
            GameFrame gameFrame,
    ...
    private void runIfEnoughTimeHasElapsed() throws InterruptedException {
        if (framesPerSecondHandler.hasEnoughTimeElapsed()) {
            ...
            threadWrapper.sleep(framesPerSecondHandler
