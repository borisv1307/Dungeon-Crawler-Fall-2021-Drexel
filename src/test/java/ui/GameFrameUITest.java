...
public class GameFrameUITest {
    ...
    public void constructor() throws Exception {
        ...
        WindowAdapterSystemExit windowAdapter = Mockito
                .mock(WindowAdapterSystemExit.class);
        ...
        Mockito.verify(gamePanel)
                .setPreferredSize(new Dimension(width, height));
        Mockito.verify(gamePanel).init();
        assertThat(gameFrame.isResizable(), equalTo(false));
        assertThat(gameFrame.getWindowListeners(),
                arrayContaining((WindowListener) windowAdapter));
    }
}
