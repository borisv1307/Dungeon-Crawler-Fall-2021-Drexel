...
public class LevelCreatorTest {
    ...
    public void file_not_found_exception() throws Exception {
        FileNotFoundException exception = Mockito
                .mock(FileNotFoundException.class);
        Mockito.when(readerWrapper
                .createBufferedReader(levelCreator.getFilePath(LEVEL)))
                .thenThrow(exception);
    ...
    public void get_file_path() {
        String filePath = FILE_LOCATION_PREFIX + LEVEL
